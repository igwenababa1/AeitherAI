    ...
    >
      ...
      <div className={`container mx-auto px-6 relative z-10 section-fade-in ${isVisible ? 'is-visible' : ''}`}>
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white font-heading">Our Story & Vision</h2>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto mt-4">
            The driving force behind our mission to redefine development.
          </p>
        </div>
        
        <div className="card-3d-container max-w-4xl mx-auto mb-12">
            <div className="bg-card-bg/60 p-8 rounded-xl border border-border-color card-3d">
                <div className="flex items-center gap-4 mb-4">
                    <BuildingLibraryIcon className="w-8 h-8 text-primary-blue" />
                    <h3 className="text-2xl font-bold text-white font-heading">Company History</h3>
                </div>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d h-full">
              <div className="flex items-center gap-3 mb-3">
                  <RocketLaunchIcon className="w-6 h-6 text-accent-violet" />
                  <h3 className="text-xl font-bold text-accent-violet font-heading">Our Mission</h3>
              </div>
              <p className="text-slate-400">
          ...
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d h-full">
              <div className="flex items-center gap-3 mb-3">
                  <EyeIcon className="w-6 h-6 text-accent-violet" />
                  <h3 className="text-xl font-bold text-accent-violet font-heading">Our Vision</h3>
              </div>
              <p className="text-slate-400">
