    ...
    return (
        ...
        >
            ...
            <div className={`container mx-auto px-6 text-center relative z-10 section-fade-in ${isVisible ? 'is-visible' : ''}`}>
                <div className="mb-4">
                    <CpuChipIcon className="w-12 h-12 mx-auto text-cyan-400" />
                </div>
                ...
                <button
                    ...
                    className="bg-transparent border-2 border-cyan-400 text-cyan-400 font-bold py-3 px-8 rounded-lg transition-all hover:scale-105 hover:bg-cyan-400 hover:text-slate-900"
                >
                    See It In Action
                </button>
            </div>
