    ...
    >
      ...
      <div className={`container mx-auto px-6 relative z-10 section-fade-in ${isVisible ? 'is-visible' : ''}`}>
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white font-heading">Technical Specification & Architecture</h2>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d">
              <h3 className="text-xl font-bold font-heading text-accent-violet mb-3">Resource Management</h3>
          ...
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d">
              <h3 className="text-xl font-bold font-heading text-accent-violet mb-3">AI Engine Orchestration</h3>
              <p className="text-slate-400">
          ...
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d">
              <h3 className="text-xl font-bold font-heading text-accent-violet mb-3">The "Project" Container</h3>
              <p className="text-slate-400">
          ...
          <div className="card-3d-container">
            <div className="bg-card-bg/60 p-6 rounded-xl border border-border-color card-3d">
              <h3 className="text-xl font-bold font-heading text-accent-violet mb-3">RBAC Implementation</h3>
              <p className="text-slate-400">
